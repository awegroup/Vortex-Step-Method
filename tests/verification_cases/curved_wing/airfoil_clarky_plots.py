...
plt.plot(np.rad2deg(data_airf[0:13, 0]), data_airf[0:13, 1], marker=".")
plt.plot(np.rad2deg(data_airf[12::, 0]), data_airf[12::, 1], marker=".")
...
plt.figure(figsize=(6, 5))
plt.plot(np.rad2deg(data_airf[0:13, 0]), data_airf[0:13, 2], marker=".")
plt.plot(np.rad2deg(data_airf[12::, 0]), data_airf[12::, 2], marker=".")
plt.legend(["CFD", "Polynomial approx."])
plt.xlabel(r"$\alpha$ [deg]")
plt.ylabel(r"$C_d  $")
plt.grid()
...
plt.figure(figsize=(6, 5))
plt.plot(
    np.rad2deg(data_airf[0:13, 0]), data_airf[0:13, 1] / data_airf[0:13, 2], marker="."
)
plt.plot(
    np.rad2deg(data_airf[12::, 0]), data_airf[12::, 1] / data_airf[12::, 2], marker="."
)
plt.legend(["CFD", "Polynomial approx."])
plt.xlabel(r"$\alpha$ [deg]")
...
aoa_0L = (
    np.arctan((x_camber[45, 1] - x_camber[44, 1]) / (x_camber[45, 0] - x_camber[44, 0]))
    * 180
    / np.pi
)
